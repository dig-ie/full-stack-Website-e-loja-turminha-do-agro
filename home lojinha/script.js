// js para passar imagens do primeiro carrosel
let count = 1;
...
setInterval( function(){
    ...
    const btnPrev = document.querySelectorAll('.proximoEsquerdoP');
    const btnNext = document.querySelectorAll('.proximoDireitoP');
